...
def randomizePermutations():
	''' 
		Add small amount of variety by using numpy's random.choice.
	 '''
	return np.random.choice(256, 256, replace=False)
...
def noise(x, y, perms):
	...
	'''
		...
		perform  lerp( lerp(TopLeft, TopRight), lerp(Bottom,left, bottomRight))
